...
async function saveAvailability() {
  ...
  const res = await fetch("https://doclink-production.up.railway.app/api/availability", {
    method: "POST",
    headers: {
...
async function loadUpcomingBookings() {
  ...
  try {
    const res = await fetch(`https://doclink-production.up.railway.app/api/bookings/doctor/${doctorId}`);
